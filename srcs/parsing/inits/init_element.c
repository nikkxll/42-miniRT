...
static void	elem_type_light(char *ent[ARGS_MAX], t_minirt *rt)
{
	if (ent[0] && ft_strcmp(ent[0], "L") == 0 && !rt->prs->light)
		init_l(ent, rt, LIGHT);
...
static void	elem_type_selection(char *ent[ARGS_MAX], t_minirt *rt)
{
	if (ent[0] && ft_strcmp(ent[0], "A") == 0)
		init_a(ent, rt);
	if (ent[0] && ft_strcmp(ent[0], "C") == 0)
		init_c(ent, rt);
	if (ent[0] && ft_strcmp(ent[0], "sp") == 0)
		init_sp(ent, rt);
	if (ent[0] && ft_strcmp(ent[0], "pl") == 0)
		init_pl(ent, rt);
